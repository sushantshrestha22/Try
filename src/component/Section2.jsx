...
export default function Section2() {
  return (
    <div className='h-[90vh] text-center px-[5%] bg-gray-100 relative flex flex-col items-center pt-[5%] block'>
      <h4 className='font-bold flex text-sky-700 text-3xl w-[80%] block '>One of the leading educational consultancy in Nepal guiding students to meet their dreams</h4>
      <p className='mt-[20px] text-md w-[80%] '>Proper abroad study guidance provided for academic growth. The best test preparation classes in the whole town. Definite information about highly renowned colleges/universities throughout the globe. Guidance for getting wide range of scholarship/fellowship. Service oriented staffs to provide information all the time. Located at heart of main cities of the country.</p>
